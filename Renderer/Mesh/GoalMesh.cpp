...
//µµÂø ÁöÁ¡ »ö±òÀº Blue
GoalMesh::GoalMesh(float topx, float topy, float bottomx, float bottomy)
{
	//This is for test
	VertexType vertices[]
	{
		VertexType{Vector3(topx, topy, 15.0f), Color(0.0f, 0.0f, 1.0f, 1.0f)},
		VertexType{Vector3(topx, bottomy, 15.0f), Color(0.0f, 0.0f, 1.0f, 1.0f)},
		VertexType{Vector3(bottomx, bottomy, 15.0f), Color(0.0f, 0.0f, 1.0f, 1.0f)},
		VertexType{Vector3(bottomx, topy, 15.0f), Color(0.0f, 0.0f, 1.0f, 1.0f)}
	};
